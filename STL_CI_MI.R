...
for (t in 1:K)
{
  ...
  result = MultipleIMputationCI(XYt, nMI=1000, impMethod = "sample", miceMaxIt = 30, LASSO=T)
  auc_CI[t,c(1,2)] = result

  result = MultipleIMputationCI(XYt, nMI=1000, impMethod = "pmm", miceMaxIt = 30, LASSO=T)
